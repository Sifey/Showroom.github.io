        ...
        else //La requête s’est bien exécutée (<=> couleur verte dans phpmyadmin)
        {
          ...
          echo ("<table cellpadding=\"20px\">");
            while ($sel = $result1->fetch_assoc())
              ...
              $requete2="SELECT ele_numero FROM t_liste_lis WHERE sel_numero=" .$sel['sel_numero']. " AND ele_numero>0 LIMIT 1;";
              ...
              $lie = $result2->fetch_assoc();
                ...
                if ($elt == "")
                {
                  echo("<td>"); echo ("<a href='./affichageselection.php?sel_numero=". $sele. "&ele_numero=0'>Voir</a>"); echo ("</td");
                }
                else
                {
                  echo("<td>"); echo ("<a href='./affichageselection.php?sel_numero=". $sele. "&ele_numero=" .$elt. "'>Voir</a>"); echo ("</td");
                }
              echo ("</tr>");
            } 
            // ------------------------------------------
